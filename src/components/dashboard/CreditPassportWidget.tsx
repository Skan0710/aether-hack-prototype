...
export const CreditPassportWidget: React.FC = () => {
  return (
    <Card className="h-full flex flex-col border-emerald-500/20 shadow-glow-pass">
      <CardHeader
      ...
      <CardContent className="flex-1 flex flex-col justify-between space-y-4">
        {/* Score Display */}
        <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-navy-850 to-emerald-950/20 border border-navy-750">
          <div>
            <div className="text-xs font-mono uppercase text-slate-400">Composite Score</div>
